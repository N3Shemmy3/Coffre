...
@Composable
fun LookNFeelSettingsScreen(viewModel: MainViewModel) {
    BaseSettingsScreenContent(
        stringResource(R.string.preference_look_n_feel),
        onBackClicked = {
            viewModel.onAction(Action.ViewFlow.Close(Route.LOOKNFEELSETTINGS))
        }
    ) {
        Card {
            Card(
...
@Preview
@Composable
fun LookNFeelSettingsScreenPreview() {
    LookNFeelSettingsScreen(viewModel = viewModel())
}