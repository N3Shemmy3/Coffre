...
@Composable
fun FormatSettingsScreen(viewModel: MainViewModel) {
    BaseSettingsScreenContent(
        stringResource(R.string.preference_format),
        onBackClicked = {
            viewModel.onAction(Action.ViewFlow.Close(Route.FORMATSETTINGS))
        }
    ) {
        Card {
            Card(
        ...
        Column(
            ...
            PreferenceItem(
                ...
                title = stringResource(R.string.preference_currency),
                summary = "Euro",
                onClick = {},
...
@Preview
@Composable
fun FormatSettingsScreenPreview() {
    FormatSettingsScreen(viewModel = viewModel())
}